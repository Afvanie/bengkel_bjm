...
<div class="w3-container w3-light-gray">
  ...
  <!-- TemplateBeginEditable name="EditRegion1" --><a href="#" style="text-decoration:none">
  ...
  <li style="border-bottom:1px solid #DDD;"><i class="fa fa-times fa-fw"></i> Keluar</li>
                    ...
                    <div class="w3-col l9" style="padding-left:8px;">
                    	<div class="w3-border w3-padding"><!-- TemplateBeginEditable name="EditRegion2" --><div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i class="fa fa-home"></i> SELAMAT DATANG</strong></div>
