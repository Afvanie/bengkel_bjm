                        ...
                        <div class="w3-col l9" style="padding-left:8px;">
                            <div class="w3-border w3-padding">
                                ...
                                <div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i
                                            class="fa fa-edit"></i> UBAH DATA GEJALA</strong></div>
                                <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                                    <ul class="w3-ul w3-border" style="margin-top:8px;">
                                        <li>Kode Gejala<span
                                                class="w3-right"><strong><?php echo $row_rsGejalaUpdate['kd_gejala']; ?></strong></span>
                                        </li>
                                    </ul>
                                    <div style="margin-top:8px;">
                                        <label>Gejala</label>
                                        <input class="w3-input w3-border w3-small" required type="text" name="gejala"
                                            value="<?php echo htmlentities($row_rsGejalaUpdate['gejala'], ENT_COMPAT, ''); ?>"
                                            size="32">
                                    </div>
                                    ...
                                    <div class="w3-center">
                                        <a onClick="window.history.back()" style="cursor:pointer"
                                            ...
                                            Batal</a> <button type="submit" class="w3-btn w3-small w3-green"><i
                                                class="fa fa-save fa-fw"></i> Simpan Perubahan</button>
                                    </div>
                                    <input type="hidden" name="MM_update" value="form1">
                                    <input type="hidden" name="kd_gejala"
                                        value="<?php echo $row_rsGejalaUpdate['kd_gejala']; ?>">
                                </form>
                                <br>
                                <!-- InstanceEndEditable -->
