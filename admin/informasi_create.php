                        ...
                        <div class="w3-col l9" style="padding-left:8px;">
                            <div class="w3-border w3-padding">
                                ...
                                <div class="w3-border-bottom" style="padding-bottom:10px; margin-top:8px;"><strong><i
                                            class="fa fa-plus"></i> TAMBAH INFORMASI SEPUTAR GIGI</strong></div>
                                ...
                                <form action="<?php echo $editFormAction; ?>" method="post"
                                    ...
                                    <div style="margin-top:8px;">
                                        <label>Judul</label>
                                        <input type="text" class="w3-input w3-border w3-small" required name="judul"
                                            value="" size="32">
                                    </div>

                                    <div style="margin-top:8px;">
                                        <label>Isi</label>
                                        <textarea name="isi" class="w3-input w3-border w3-small" required cols="50"
                                            rows="5"></textarea>
                                    </div>

                                    <div style="margin-top:8px;">
                                        <label>Gambar</label>
                                        <input type="file" class="w3-input w3-border w3-small" required name="gambar"
                                            id="gambar">
                                    </div>
                                    <table align="center" style="display:none">
                                        <tr valign="baseline">
                                            <td nowrap align="right">Id_info:</td>
                                            <td><input type="text" name="id_info"
                                                    value="<?php echo "INF".substr(str_shuffle($IDNYA),0,7); ?>"
                                                    size="32"></td>
                                        </tr>
                                        <tr valign="baseline">
                                        ...
                                        <tr valign="baseline">
                                            ...
                                            <td>
                                                <!-- #BeginDate format:fcSw1m -->Tuesday, 4 August, 2020 13:49
                                                <!-- #EndDate -->
                                            </td>
                                        </tr>
                                        <tr valign="baseline">
